                            ...
                            <div class="card-body">
                                <form action="{{ route('profile.update', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        {{-- Modulo di modifica short_description --}}
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="short_description">Breve Descrizione</label>
                                            <input class="form-control" id="short_description" name="short_description" for="short_description" type="text" placeholder="Breve Biografia" value="{{$user->short_description}}">
                                        </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6"> 
                                            <label class="small mb-1" for="company_address">Indrizizzo compagnia</label>
