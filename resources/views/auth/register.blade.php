            ...
            <div class="col-8">
                ...
                <form method="POST" action="{{route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="phone" type="phone" class="form-control" id="phone" aria-describedby="phone" placeholder="Telefono">
                    </div>
                    ...
                    <a href="{{route('login')}}">Se sei già registrato clicca qui!</a>
